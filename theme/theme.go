...
var builtinThemeCatalog = []ThemeOption{
	...
	newBuiltinThemeOption("castor", "Castor", ThemePalette{
		Background:     "#36272B",
		Panel:          "#402E33",
		Element:        "#402E33",
		Border:         "#6B4D55",
		...
		Warning:        "#FFD275",
		Error:          "#FF5E6C",
		PromptCursorBG: "#FF6B81",
		PromptCursorFG: "#36272B",
		CodeBackground: "#2D1F23",
		CodeKeyword:    "#FF6B81",
		CodeType:       "#FFA6B5",
		CodeString:     "#8CE6A4",
		CodeNumber:     "#FFD275",
	...
	newBuiltinThemeOption("peach-club-soda", "Peach Club Soda", ThemePalette{
		Background:     "#FFF3EA",
		Panel:          "#FFE8D6",
		Element:        "#FFD9BF",
		Border:         "#F2B79E",
		...
		Warning:        "#F6B85A",
		Error:          "#E86F6A",
		PromptCursorBG: "#FF8F70",
		PromptCursorFG: "#FFF3EA",
