...
const (
	...
	HomeActionInspectOnboardingRepository    HomeActionKind = "inspect-onboarding-repository"
	HomeActionDiscoverOnboardingRepositories HomeActionKind = "discover-onboarding-repositories"
	HomeActionReviewOnboardingRepository     HomeActionKind = "review-onboarding-repository"
