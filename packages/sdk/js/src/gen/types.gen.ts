...
export type Config = {
    ...
    tui?: {
        ...
        show_header?: boolean;
        /**
         * Diff display style: auto (based on width), split (side-by-side), or stacked (unified)
         */
        diff_style?: 'auto' | 'split' | 'stacked';
    };
    /**
     * Command configuration, see https://swarm.ai/docs/commands
     */
    command?: {
        [key: string]: {
            template: string;
    ...
    /**
     * Agent configuration, see https://swarm.ai/docs/agent
     */
    agent?: {
        plan?: AgentConfig;
        build?: AgentConfig;
    ...
    permission?: {
        ...
        external_directory?: 'ask' | 'allow' | 'deny' | 'pin';
        /**
         * Permission for spawning background agents (default: ask)
         */
        background_agent?: 'ask' | 'allow' | 'deny' | 'pin';
    };
    /**
    ...
    backgroundAgent?: {
        /**
         * Additional instructions prepended to background agent prompts
         */
        prompt?: string;
        /**
         * Override permissions specifically for background agents
         */
        permission?: {
            edit?: 'ask' | 'allow' | 'deny' | 'pin';
            bash?: ('ask' | 'allow' | 'deny' | 'pin') | {
    ...
    /**
     * Desktop notification settings for blocked states
     */
    notifications?: {
        /**
         * Enable desktop notifications when blocked
         */
        enabled?: boolean;
        /**
         * Delay in ms before sending notification when blocked (default: 5000)
         */
        delayMs?: number;
    };
    /**
...
export type EventSwarmStatusUpdated = {
    type: 'swarm.status.updated';
    properties: {
...
export type EventSessionCompleted = {
...
export type EventSessionAgentSwitch = {
    type: 'session.agent_switch';
    properties: {
        sessionID: string;
        agent: string;
        timestamp: number;
...
export type EventSessionCompactingProgress = {
    type: 'session.compacting.progress';
    properties: {
        sessionID: string;
...
export type EventBackgroundAgentUpdated = {
    type: 'background-agent.updated';
    properties: {
        info: BackgroundAgent;
    };
};

export type EventBackgroundAgentCompleted = {
    type: 'background-agent.completed';
    properties: {
        info: BackgroundAgent;
    };
};

export type EventBackgroundAgentFailed = {
    type: 'background-agent.failed';
    properties: {
        info: BackgroundAgent;
        error: string;
    };
...
export type BackgroundAgentListResponses = {
    /**
     * List of background agents
     */
    200: Array<BackgroundAgent>;
};

export type BackgroundAgentListResponse = BackgroundAgentListResponses[keyof BackgroundAgentListResponses];

export type BackgroundAgentAbortData = {
    body?: never;
    path: {
        id: string;
    };
...
export type BackgroundAgentAbortErrors = {
    /**
     * Bad request
     */
    400: BadRequestError;
...
export type BackgroundAgentAbortError = BackgroundAgentAbortErrors[keyof BackgroundAgentAbortErrors];

export type BackgroundAgentAbortResponses = {
    /**
     * Background agent aborted
     */
    200: boolean;
};

export type BackgroundAgentAbortResponse = BackgroundAgentAbortResponses[keyof BackgroundAgentAbortResponses];

export type BackgroundAgentGetData = {
    body?: never;
    path: {
        id: string;
    };
...
export type BackgroundAgentGetErrors = {
    /**
     * Not found
     */
    404: NotFoundError;
...
export type BackgroundAgentGetError = BackgroundAgentGetErrors[keyof BackgroundAgentGetErrors];

export type BackgroundAgentGetResponses = {
    /**
...
export type BackgroundAgentGetResponse = BackgroundAgentGetResponses[keyof BackgroundAgentGetResponses];
...
export type TuiPublishData = {
    body?: EventTuiPromptAppend | EventTuiCommandExecute | EventTuiToastShow | EventSwarmStatusUpdated;
    path?: never;
    query?: {
        directory?: string;
    };
