...
import type { ProjectListData, ProjectListResponses, ProjectCurrentData, ProjectCurrentResponses, ProfileListData, ProfileListResponses, ProfileCreateData, ProfileCreateResponses, ProfileCreateErrors, ProfileDeleteData, ProfileDeleteResponses, ProfileDeleteErrors, ProfileGetData, ProfileGetResponses, ProfileGetErrors, ProfileUpdateData, ProfileUpdateResponses, ProfileUpdateErrors, ProfileStartData, ProfileStartResponses, ProfileStartErrors, ProfileStopData, ProfileStopResponses, ProfileStopErrors, ProfileRestartData, ProfileRestartResponses, ProfileRestartErrors, ProfileStatusData, ProfileStatusResponses, ProfileStatusErrors, ProfileLogsData, ProfileLogsResponses, ProfileLogsErrors, ProfileExecData, ProfileExecResponses, ProfileExecErrors, ProfileEventsData, ProfileEventsResponses, ConfigGetData, ConfigGetResponses, ConfigUpdateData, ConfigUpdateResponses, ConfigUpdateErrors, ToolIdsData, ToolIdsResponses, ToolIdsErrors, ToolListData, ToolListResponses, ToolListErrors, PathGetData, PathGetResponses, SessionListData, SessionListResponses, SessionCreateData, SessionCreateResponses, SessionCreateErrors, SessionDeleteData, SessionDeleteResponses, SessionDeleteErrors, SessionGetData, SessionGetResponses, SessionGetErrors, SessionUpdateData, SessionUpdateResponses, SessionUpdateErrors, SessionChildrenData, SessionChildrenResponses, SessionChildrenErrors, SessionTodoData, SessionTodoResponses, SessionTodoErrors, SessionInitData, SessionInitResponses, SessionInitErrors, SessionForkData, SessionForkResponses, SessionAbortData, SessionAbortResponses, SessionAbortErrors, SessionSwitchAgentData, SessionSwitchAgentResponses, SessionSwitchAgentErrors, SessionDiffData, SessionDiffResponses, SessionDiffErrors, SessionSummarizeData, SessionSummarizeResponses, SessionSummarizeErrors, SessionMessagesData, SessionMessagesResponses, SessionMessagesErrors, SessionPromptData, SessionPromptResponses, SessionPromptErrors, SessionMessageData, SessionMessageResponses, SessionMessageErrors, SessionCommandData, SessionCommandResponses, SessionCommandErrors, SessionShellData, SessionShellResponses, SessionShellErrors, SessionRevertData, SessionRevertResponses, SessionRevertErrors, SessionUnrevertData, SessionUnrevertResponses, SessionUnrevertErrors, PostSessionIdPermissionsPermissionIdData, PostSessionIdPermissionsPermissionIdResponses, PostSessionIdPermissionsPermissionIdErrors, CommandListData, CommandListResponses, ConfigProvidersData, ConfigProvidersResponses, FindTextData, FindTextResponses, FindFilesData, FindFilesResponses, FindSymbolsData, FindSymbolsResponses, FileListData, FileListResponses, FileReadData, FileReadResponses, FileStatusData, FileStatusResponses, AppLogData, AppLogResponses, AppLogErrors, AppAgentsData, AppAgentsResponses, AgentCreateData, AgentCreateResponses, AgentCreateErrors, AgentDeleteData, AgentDeleteResponses, AgentDeleteErrors, AgentGetData, AgentGetResponses, AgentGetErrors, AgentUpdateData, AgentUpdateResponses, AgentUpdateErrors, BackgroundAgentListData, BackgroundAgentListResponses, BackgroundAgentAbortData, BackgroundAgentAbortResponses, BackgroundAgentAbortErrors, BackgroundAgentGetData, BackgroundAgentGetResponses, BackgroundAgentGetErrors, McpStatusData, McpStatusResponses, McpAddData, McpAddResponses, McpAddErrors, LspStatusData, LspStatusResponses, FormatterStatusData, FormatterStatusResponses, TuiAppendPromptData, TuiAppendPromptResponses, TuiAppendPromptErrors, TuiOpenHelpData, TuiOpenHelpResponses, TuiOpenSessionsData, TuiOpenSessionsResponses, TuiOpenThemesData, TuiOpenThemesResponses, TuiOpenModelsData, TuiOpenModelsResponses, TuiSubmitPromptData, TuiSubmitPromptResponses, TuiClearPromptData, TuiClearPromptResponses, TuiExecuteCommandData, TuiExecuteCommandResponses, TuiExecuteCommandErrors, TuiShowToastData, TuiShowToastResponses, TuiPublishData, TuiPublishResponses, TuiPublishErrors, TuiControlNextData, TuiControlNextResponses, TuiControlResponseData, TuiControlResponseResponses, AuthSetData, AuthSetResponses, AuthSetErrors, EventSubscribeData, EventSubscribeResponses } from './types.gen.js';
...
class Profile extends _HeyApiClient {
    /**
     * List all profiles
     */
    public list<ThrowOnError extends boolean = false>(options?: Options<ProfileListData, ThrowOnError>) {
        return (options?.client ?? this._client).get<ProfileListResponses, unknown, ThrowOnError>({
            url: '/profile',
            ...options
        });
    }
     ...
     */
    public create<ThrowOnError extends boolean = false>(options?: Options<ProfileCreateData, ThrowOnError>) {
        return (options?.client ?? this._client).post<ProfileCreateResponses, ProfileCreateErrors, ThrowOnError>({
            url: '/profile',
            ...options,
            headers: {
     ...
     * Delete a profile
     */
    public delete<ThrowOnError extends boolean = false>(options: Options<ProfileDeleteData, ThrowOnError>) {
        return (options.client ?? this._client).delete<ProfileDeleteResponses, ProfileDeleteErrors, ThrowOnError>({
            url: '/profile/{name}',
            ...options
        });
    }
     ...
     */
    public get<ThrowOnError extends boolean = false>(options: Options<ProfileGetData, ThrowOnError>) {
        return (options.client ?? this._client).get<ProfileGetResponses, ProfileGetErrors, ThrowOnError>({
            url: '/profile/{name}',
            ...options
        });
    }
     ...
     * Update a profile
     */
    public update<ThrowOnError extends boolean = false>(options: Options<ProfileUpdateData, ThrowOnError>) {
        return (options.client ?? this._client).patch<ProfileUpdateResponses, ProfileUpdateErrors, ThrowOnError>({
            url: '/profile/{name}',
            ...options,
            headers: {
                'Content-Type': 'application/json',
     ...
     */
    public start<ThrowOnError extends boolean = false>(options: Options<ProfileStartData, ThrowOnError>) {
        return (options.client ?? this._client).post<ProfileStartResponses, ProfileStartErrors, ThrowOnError>({
     ...
     */
    public stop<ThrowOnError extends boolean = false>(options: Options<ProfileStopData, ThrowOnError>) {
        return (options.client ?? this._client).post<ProfileStopResponses, ProfileStopErrors, ThrowOnError>({
     ...
     */
    public restart<ThrowOnError extends boolean = false>(options: Options<ProfileRestartData, ThrowOnError>) {
        return (options.client ?? this._client).post<ProfileRestartResponses, ProfileRestartErrors, ThrowOnError>({
    ...
    /**
     * Get container status for a profile
     */
    public status<ThrowOnError extends boolean = false>(options: Options<ProfileStatusData, ThrowOnError>) {
        return (options.client ?? this._client).get<ProfileStatusResponses, ProfileStatusErrors, ThrowOnError>({
     ...
     */
    public logs<ThrowOnError extends boolean = false>(options: Options<ProfileLogsData, ThrowOnError>) {
        return (options.client ?? this._client).get.sse<ProfileLogsResponses, ProfileLogsErrors, ThrowOnError>({
     ...
     */
    public exec<ThrowOnError extends boolean = false>(options: Options<ProfileExecData, ThrowOnError>) {
        return (options.client ?? this._client).post<ProfileExecResponses, ProfileExecErrors, ThrowOnError>({
     ...
     */
    public events<ThrowOnError extends boolean = false>(options: Options<ProfileEventsData, ThrowOnError>) {
        return (options.client ?? this._client).get.sse<ProfileEventsResponses, unknown, ThrowOnError>({
...
class Agent extends _HeyApiClient {
     ...
     * Create a new agent
     */
    public create<ThrowOnError extends boolean = false>(options?: Options<AgentCreateData, ThrowOnError>) {
        return (options?.client ?? this._client).post<AgentCreateResponses, AgentCreateErrors, ThrowOnError>({
            url: '/agent',
            ...options,
            headers: {
                'Content-Type': 'application/json',
     ...
     * Delete an agent
     */
    public delete<ThrowOnError extends boolean = false>(options: Options<AgentDeleteData, ThrowOnError>) {
        return (options.client ?? this._client).delete<AgentDeleteResponses, AgentDeleteErrors, ThrowOnError>({
            url: '/agent/{name}',
            ...options
        });
    }
     ...
     */
    public get<ThrowOnError extends boolean = false>(options: Options<AgentGetData, ThrowOnError>) {
        return (options.client ?? this._client).get<AgentGetResponses, AgentGetErrors, ThrowOnError>({
            url: '/agent/{name}',
            ...options
        });
    }
     ...
     */
    public update<ThrowOnError extends boolean = false>(options: Options<AgentUpdateData, ThrowOnError>) {
        return (options.client ?? this._client).put<AgentUpdateResponses, AgentUpdateErrors, ThrowOnError>({
            url: '/agent/{name}',
            ...options,
            headers: {
                'Content-Type': 'application/json',
...
class BackgroundAgent extends _HeyApiClient {
    /**
     * List all background agents
     */
    public list<ThrowOnError extends boolean = false>(options?: Options<BackgroundAgentListData, ThrowOnError>) {
        return (options?.client ?? this._client).get<BackgroundAgentListResponses, unknown, ThrowOnError>({
            url: '/background-agent',
            ...options
        });
    }
     ...
     */
    public abort<ThrowOnError extends boolean = false>(options: Options<BackgroundAgentAbortData, ThrowOnError>) {
        return (options.client ?? this._client).delete<BackgroundAgentAbortResponses, BackgroundAgentAbortErrors, ThrowOnError>({
            url: '/background-agent/{id}',
            ...options
        });
    }
     ...
     */
    public get<ThrowOnError extends boolean = false>(options: Options<BackgroundAgentGetData, ThrowOnError>) {
        return (options.client ?? this._client).get<BackgroundAgentGetResponses, BackgroundAgentGetErrors, ThrowOnError>({
            url: '/background-agent/{id}',
            ...options
        });
    }
...
export class OpencodeClient extends _HeyApiClient {
     ...
     */
    public postSessionIdPermissionsPermissionId<ThrowOnError extends boolean = false>(options: Options<PostSessionIdPermissionsPermissionIdData, ThrowOnError>) {
        return (options.client ?? this._client).post<PostSessionIdPermissionsPermissionIdResponses, PostSessionIdPermissionsPermissionIdErrors, ThrowOnError>({
    ...
    profile = new Profile({ client: this._client });
    ...
    backgroundAgent = new BackgroundAgent({ client: this._client });
