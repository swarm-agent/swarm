...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SWARM_CALLER", () => {
    process.env["SWARM_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SWARM_CALLER", () => {
    process.env["SWARM_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SWARM_CALLER", () => {
    process.env["SWARM_CALLER"] = "unknown"
