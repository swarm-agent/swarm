...
import type { FilePart, AssistantMessage } from "@swarm-ai/sdk"
...
export function Prompt(props: PromptProps) {
  ...
  // Track last ctrl+c press for double-tap to exit
  let lastCtrlCTime = 0
    ...
    <>
      ...
      <box ref={(r) => (anchor = r)}>
        <box flexDirection="row" justifyContent="space-evenly">
          <box width={3} height="100%" alignItems="center" paddingTop={1}>
            ...
            <textarea
              ...
              onKeyDown={async (e: any) => {
                ...
                if (keybind.match("app_exit", e)) {
                  const now = Date.now()
                  // Double-tap ctrl+c to exit, single tap scrolls to bottom
