import type { Hooks, PluginInput, Plugin as PluginInstance } from "@swarm-ai/plugin"
import { Config } from "../config/config"
import { Bus } from "../bus"
import { Log } from "../util/log"
import { createOpencodeClient } from "@swarm-ai/sdk"
...
export namespace Plugin {
  ...
  export async function init() {
    ...
    for (const hook of hooks) {
      // Cast config to any since plugin SDK types may not include all permission types
