...
prepare_isolated_host() {
  ...
  HOST_DAEMON_CONFIG_ROOT="${HOST_ROOT}/daemon/config"
  HOST_DAEMON_LOG_ROOT="${HOST_ROOT}/daemon/log"

  mkdir -p "${HOST_XDG_BIN_HOME}" "${HOST_XDG_CONFIG_HOME}" "${HOST_XDG_DATA_HOME}" "${HOST_XDG_STATE_HOME}" "${HOST_XDG_CACHE_HOME}" \
    "${HOST_DAEMON_DATA_ROOT}" "${HOST_DAEMON_RUNTIME_ROOT}" "${HOST_DAEMON_CACHE_ROOT}" "${HOST_DAEMON_CONFIG_ROOT}" "${HOST_DAEMON_LOG_ROOT}"
  ...
  export STATE_ROOT="${HOST_DAEMON_RUNTIME_ROOT}"
  export DATA_DIR="${HOST_DAEMON_DATA_ROOT}"
  export DB_PATH="${DATA_DIR}/swarmd.pebble"
  export LOCK_PATH="${STATE_ROOT}/swarmd.lock"
  export PID_FILE="${STATE_ROOT}/swarmd.pid"
  export LOG_FILE="${HOST_DAEMON_LOG_ROOT}/swarmd.log"
  export STATE_DIRECTORY="${HOST_DAEMON_DATA_ROOT}"
  export RUNTIME_DIRECTORY="${HOST_DAEMON_RUNTIME_ROOT}"
  export CACHE_DIRECTORY="${HOST_DAEMON_CACHE_ROOT}"
  export CONFIGURATION_DIRECTORY="${HOST_DAEMON_CONFIG_ROOT}"
  export LOGS_DIRECTORY="${HOST_DAEMON_LOG_ROOT}"
