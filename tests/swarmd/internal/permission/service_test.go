...
func TestShouldApproveManageAgentMutation(t *testing.T) {
	cases := []struct {
		...
		{name: "set_active_subagent", arguments: `{"action":"set_active_subagent","purpose":"finder","agent":"demo"}`, want: false},
		{name: "remove_active_subagent", arguments: `{"action":"remove_active_subagent","purpose":"finder"}`, want: false},
...
func TestAuthorizeToolCallManageAgentByAction(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "set_active_subagent", arguments: `{"action":"set_active_subagent","purpose":"finder","agent":"demo"}`, wantRequirement: "manage_agent", wantDecision: AuthorizationApprove, wantRecord: false},
		{name: "remove_active_subagent", arguments: `{"action":"remove_active_subagent","purpose":"finder"}`, wantRequirement: "manage_agent", wantDecision: AuthorizationApprove, wantRecord: false},
