...
func TestPlanAutomationIntentValidationAndClone(t *testing.T) {
	...
	for _, change := range []func(*store.SessionPlanAutomationIntent){
		...
		func(a *store.SessionPlanAutomationIntent) { a.Definition.Schedule.Timezone = "" },
