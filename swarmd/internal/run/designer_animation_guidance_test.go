...
func TestWriteDesignerAnimationGuidanceIncludesCommonPerformanceContract(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"runtime object must expose the ready, seek, and stop functions themselves",
		"never publish placeholders or later replace those function properties after binding",
		"trusted preflight freezes the first bound object",
