...
func ResolvePreference(modelService *model.Service, agentService *agentruntime.Service, settingsService *agentmodelsettings.Service, accountScopeID string, basePreference pebblestore.ModelPreference) (model.ResolvedPreference, pebblestore.AgentProfile, error) {
