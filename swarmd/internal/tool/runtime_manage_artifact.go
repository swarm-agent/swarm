	...
	return Definition{
		...
		Parameters: map[string]any{
			...
			"properties": map[string]any{
				...
				"event_seq":              map[string]any{"type": "integer", "minimum": 1, "description": "Exact ready event sequence. For get/read/materialize/promote/export_html_stills of an attached ready artifact, copy this together with session_id, collection_id, and variant_id from the same returned reference."},
