...
func manageVideoAnimationCandidatesSchema() map[string]any {
	...
	return map[string]any{"type": "object", "description": "Optional one-of-many exact ready text/html candidates for live swarm-player/v1 preview. Visual remains the render-ready fallback/derivative; only the selected candidate is exported.", "properties": map[string]any{
