...
func (s *Server) registerRuntimeRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/v1/alerts/inbox", s.handleNotifications)
	...
	mux.HandleFunc("/v1/storage/deliverables/", s.handleStorageDeliverables)
	mux.HandleFunc("/v1/feedback", s.handleDesktopFeedback)
	...
	mux.HandleFunc(AutomationsV2Path+"/trigger", s.handleAutomationsV2)
	mux.HandleFunc(AutomationsV2Path+"/token", s.handleAutomationsV2)
