...
func (s *Server) registerRuntimeRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc(V3PlanRuntimeHydratePath, s.handleSessionsV3PlanRuntimeHydrate)
	mux.HandleFunc(V3PlanRuntimeReplayPath, s.handleSessionsV3PlanRuntimeReplay)
	mux.HandleFunc(V3PlanRuntimeCommandPath, s.handleSessionsV3PlanRuntimeCommand)
