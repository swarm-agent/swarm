...
func (s *Server) registerRuntimeRoutes(mux *http.ServeMux) {
	...
	// Automations endpoints disabled for launch.
	mux.HandleFunc(AutomationsV2Path, s.handleAutomationsDisabled)
	mux.HandleFunc(AutomationsV2Path+"/", s.handleAutomationsDisabled)
	mux.HandleFunc(AutomationsPath, s.handleAutomationsDisabled)
	mux.HandleFunc(AutomationsPath+"/", s.handleAutomationsDisabled)
