...
func TestSessionRepositoryParentIdentityIsExactAndOwned(t *testing.T) {
	...
	put(pebblestore.SessionSnapshot{ID: "child", AccountScopeID: principal.AccountScopeID, UserID: principal.UserID, WorkspacePath: lane, Metadata: map[string]any{"parent_session_id": "parent"}})
