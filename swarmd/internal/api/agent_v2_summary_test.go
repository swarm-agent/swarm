...
func TestCompactAgentStateForDesktopOmitsSettingsOnlyPayload(t *testing.T) {
	...
	for _, required := range []string{"profiles", "active_primary", "swarm", "runtime_mode", "plan_auto", "enabled", "model_mode", "split", "plan_provider", "plan_model", "plan_thinking", "plan_service_tier", "auto_provider", "auto_model", "auto_thinking", "auto_service_tier", "gpt-5.4", "gpt-5.4-mini", "fast", "flex"} {
