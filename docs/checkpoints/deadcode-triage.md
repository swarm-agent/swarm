...
| 261–309 | `store/pebble/keys.go`: exported Integration key families | public-api-retain | Integration storage remains account-scoped; retired product key families have been removed. |
...
- **No exported-key cleanup batch:** swarmd lines 245–309 include storage, Integration, and migration contracts.
