...
test('artifact sidebar renders authorized thumbnail previews and opens full gallery selection', async () => {
  ...
  assert.match(sidebar, /desktopV3ArtifactStudioStoryboard/)
  assert.match(sidebar, /One initial proposal/)
  assert.match(sidebar, /data-artifact-sidebar-storyboard-part/)
  ...
  assert.match(sidebar, /data-artifact-sidebar-section/)
  assert.match(sidebar, /data-artifact-sidebar-document-row/)
  assert.match(sidebar, /data-artifact-sidebar-supporting-row/)
  assert.match(sidebar, /Show supporting render assets/)
  assert.match(sidebar, /Current authored turn/)
  assert.match(sidebar, /Authoritative head/)
  ...
  assert.match(gallery, /data-artifact-studio-storyboard/)
  assert.match(gallery, /One storyboard · \{selectedStoryboard\.parts\.length\} ordered parts/)
  assert.match(gallery, /selectPartIterationArtifact\(target, part\.id\)/)
