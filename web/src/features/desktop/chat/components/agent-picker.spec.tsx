...
test('agent picker is separate from mode and keeps canonical switching and settings callbacks', () => {
  ...
  assert.match(pickerSource, /aria-label=\{`\$\{section\.label\} agents`\}/)
  ...
  assert.match(composerSource, /initialAgentName=\{agentSetupInitialAgent\}/)
  assert.match(composerSource, /onOpenAgentSettings=\{onOpenAgentSettings \? \(\) => onOpenAgentSettings/)
