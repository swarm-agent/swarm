...
test('agent picker is separate from mode and keeps canonical switching and settings callbacks', () => {
  ...
  assert.doesNotMatch(pickerSource, /Shows thinking responses|onThinkingTagsToggle/)
  ...
  assert.match(composerSource, /<AgentModelControl[\s\S]*thinkingTagsEnabled=\{thinkingTagsEnabled\}[\s\S]*onThinkingTagsToggle=\{onThinkingTagsToggle\}/)
