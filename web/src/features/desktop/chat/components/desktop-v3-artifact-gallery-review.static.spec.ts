...
test('artifact gallery is a live collection review surface distinct from plan execution', async () => {
  ...
  assert.match(gallery, /selectStudioArtifact\(artifact\)/)
  assert.match(gallery, /selectArtifact\(artifact, false\)/)
  assert.match(gallery, /iterationAutoplaySectionRef\.current = artifact\.lineage\?\.iterationSectionId/)
  ...
  assert.match(gallery, /const sectionId = iterationAutoplaySectionRef\.current/)
  assert.match(gallery, /alternatives\.map\(renderStudioBranch\)/)
  ...
  assert.match(gallery, /setStudioActiveBranchId\(artifactSelectionKey\(artifact\)\)/)
  ...
  assert.match(gallery, /const studioSectionId = iterationSection\?\.id \?\? selected\?\.lineage\?\.iterationSectionId/)
