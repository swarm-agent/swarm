...
const DESKTOP_SLASH_COMMANDS: DesktopSlashCommand[] = [
  ...
  },
  {
    ...
    command: '/swarm',
    aliases: [],
    hint: 'Open swarm settings',
    actionLabel: 'Open Settings → Swarm',
    tips: ['/swarm', 'Edit this device name', 'Keep your local identity tidy'],
    state: 'ready',
  ...
  },
  {
    ...
    command: '/mcp',
    aliases: [],
    hint: 'MCP server management is not available yet',
    actionLabel: 'Coming soon',
    tips: ['/mcp add <id> <url>', '/mcp enable <id>', 'Coming later'],
    state: 'coming-soon',
    action: { kind: 'show-help' },
  },
  {
