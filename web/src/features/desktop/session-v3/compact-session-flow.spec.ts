    ...
    hydrate: async (input) => {
      ...
      return {
        ...
        sync_scope: {
          ...
          resource_set: 'active_plan,current_run_state,membership,messages,projections,run_intents,session_view,sessions,tombstones',
        },
        scope_id: 'selector-hash:active_plan,current_run_state,membership,messages,projections,run_intents,session_view,sessions,tombstones',
