...
assert.match(source, /saveCompactAgentSettings\([\s\S]*utilityProvider[\s\S]*utilityModel[\s\S]*utilityThinking/, 'Set Utility AI must persist Compact provider, model, and thinking')
