...
export function AutomationToolPage() {
  ...
  return <AutomationWorkspace key={workspace.workspaceId} workspaceId={workspace.workspaceId} workspacePath={workspace.path} workspaceName={workspace.workspaceName} workspaceSlug={params.workspaceSlug!} initialSessionId={search?.sessionId} />
}
