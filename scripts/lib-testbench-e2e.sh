...
swarm_testbench_load_env() {
  ...
  SWARM_TESTBENCH_ACTION_MODEL="${SWARM_TESTBENCH_ACTION_MODEL:-${SWARM_TESTBENCH_MODEL}}"
  SWARM_TESTBENCH_ACTION_THINKING="${SWARM_TESTBENCH_ACTION_THINKING:-${SWARM_TESTBENCH_THINKING}}"
  SWARM_TESTBENCH_PLAN_MODEL="${SWARM_TESTBENCH_PLAN_MODEL:-${SWARM_TESTBENCH_MODEL}}"
  SWARM_TESTBENCH_PLAN_THINKING="${SWARM_TESTBENCH_PLAN_THINKING:-${SWARM_TESTBENCH_THINKING}}"
  SWARM_TESTBENCH_CODER_MODEL="${SWARM_TESTBENCH_CODER_MODEL:-${SWARM_TESTBENCH_ACTION_MODEL}}"
  SWARM_TESTBENCH_CODER_THINKING="${SWARM_TESTBENCH_CODER_THINKING:-${SWARM_TESTBENCH_ACTION_THINKING}}"
  SWARM_TESTBENCH_DESIGNER_MODEL="${SWARM_TESTBENCH_DESIGNER_MODEL:-${SWARM_TESTBENCH_ACTION_MODEL}}"
  SWARM_TESTBENCH_DESIGNER_THINKING="${SWARM_TESTBENCH_DESIGNER_THINKING:-${SWARM_TESTBENCH_ACTION_THINKING}}"
