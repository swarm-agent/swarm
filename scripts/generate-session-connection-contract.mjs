...
function writeGo() {
  const goDefs = [
    ...
    goStruct('SessionStartMessage', defs.SessionStartMessage),
    goStruct('SessionStartRequest', defs.SessionStartRequest),
    goStruct('SessionAcceptedRun', defs.SessionAcceptedRun),
    goStruct('SessionMessageAcceptedResponse', defs.SessionMessageAcceptedResponse),
    goStruct('SessionStartResponse', defs.SessionStartResponse),
...
function writeTS() {
  const tsDefs = [
    ...
    tsType('SessionStartMessage', defs.SessionStartMessage),
    tsType('SessionStartRequest', defs.SessionStartRequest),
    tsType('SessionAcceptedRun', defs.SessionAcceptedRun),
    tsType('SessionMessageAcceptedResponse', defs.SessionMessageAcceptedResponse),
    tsType('SessionStartResponse', defs.SessionStartResponse),
